...
import LinearViewpage from "../linear-profit/LinearViewpage";
...
const DirectCardPaper = styled(Paper)(({ theme, ExecuteButtonType }) => ({
  ...
  "& p": {
    color: ExecuteButtonType ? "#FFFFFF" : "#fff",
  ...
  "& .papermainCardBox": {
    background: ExecuteButtonType ? "red !important" : "#FFFFFF1A !important",
  },
            ...
            {!ExecuteButtonType && (
              <>
                <Button
                  ...
                  // disabled={!userData.subscriptionPlaneStatus}
                  onClick={(e) => {
                    e.stopPropagation();
                    if (
