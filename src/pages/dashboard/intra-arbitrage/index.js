...
// import TriangularCard from "../trainguler-arbitrage/TriangularCard";
...
export default function Triangular() {
  ...
  const [tabView, setTabView] = useState("integratedArb");
      ...
      >
        <Box className="tabBox-main">
          ...
          <Button
            ...
            onClick={() => router.push("/dashboard/traingular-arbitrage")}
            sx={{
